        ...
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            ...
            <p>
               ...
               Une page d'exemples (e.g. pagination et tables) est disponible <a href="bootswatch.php">ici</a>, mais l'essentiel est déjà sur la page <a href="records.php">Records</a>.<br />
