      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            ...
            <h2>ToDos</h2>
            <div class="checkbox">
              <label><input checked class="active" type="checkbox"> Modifier le nécessaire pour passer le site sous PHP ;</label><br />
              <label><input checked type="checkbox"> Faire une fonction qui lit le fichier <a href="./assets/data/records.json">records.json</a> et qui retourne une variable (<a href="http://php.net/manual/en/function.json-decode.php">hint</a>) ;</label><br />
